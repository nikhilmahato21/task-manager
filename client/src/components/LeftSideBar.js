...
const LeftSideBar = () => {
    const { totalTasks, expiredTasks } = (0, taskContext_1.useTasks)();
    return (<div className="h-full bg-gray-100 p-6">
      <button className=" bg-slate-800 text-white rounded-full w-60 p-3 m-1" onClick={() => {
          ...
          <li className="mb-4 shadow-md">
            <div className=" flex flex-col p-2 h-40 bg-gray-200 rounded-md">
              <span className="h-12 w-12 flex justify-center items-center  bg-red-600 rounded-full ">
                <img src="https://res.cloudinary.com/dynbpb9u0/image/upload/v1724000798/icons8-expired-50_1_ttxv7x.png" alt="" className="h-6 w-6 object-cover"/>
              </span>
          ...
          <li className="mb-4 shadow-md">
            <div className="flex flex-col p-2 h-40 bg-gray-200 rounded-md">
              <span className="h-12 w-12 flex justify-center items-center  bg-rose-300 rounded-full ">
                {" "}
                <img src="https://res.cloudinary.com/dynbpb9u0/image/upload/v1724000933/icons8-suitcase-64_1_by8phb.png" alt="suitcase" className="h-6 w-6 object-cover"/>{" "}
              </span>
          ...
          <li className="shadow-md">
            <div className="flex flex-col p-2  h-40 bg-gray-200 rounded-md">
              <span className="h-12 w-12 flex justify-center items-center  bg-sky-400 rounded-full ">
                <img src="https://res.cloudinary.com/dynbpb9u0/image/upload/v1724000933/icons8-clock-50_1_vgxe4h.png" alt="clock" className="h-6 w-6 object-cover"/>
              </span>
